...
data class Resources(
    ...
    val totalSmeltTime: Duration = resources.map { it.resourceType.smeltTime * it.quantity }.sum()

    val totalCraftTime: Duration = resources.map { it.resourceType.craftTime * it.quantity }.sum()
