...
enum class ItemType(
    ...
    LASER_TORCH(Price(30_000_000), Price(20_000_000), 7200.sec(), Resources.of(5 of BRONZE_BAR, 2 of LASER, 5 of LENSE)),
    ADVANCED_BATTERY(Price(35_000_000), Price(30_000_000), 9000.sec(), Resources.of(20 of STEEL_BAR, 30 of BATTERY)),
    THERMAL_SCANNER(Price(71_500_000), Price(50_000_000), 10750.sec(), Resources.of(5 of PLATINUM_BAR, 2 of LASER, 5 of GLASS)),
    ADVANCED_COMPUTER(Price(180_000_000), Price(120_000_000), 12500.sec(), Resources.of(5 of TITANIUM_BAR, 5 of BASIC_COMPUTER)),
    NAVIGATION_MODULE(Price(960_000_000), Price(250_000_000), 13500.sec(), Resources.of(1 of THERMAL_SCANNER, 2 of LASER_TORCH)),
    PLASMA_TORCH(Price(1_080_000_000), Price(550_000_000), 15000.sec(), Resources.of(15 of IRIDIUM_BAR, 5 of LASER_TORCH)),
    RADIO_TOWER(Price(1_450_000_000), Price(1_500_000_000), 15600.sec(), Resources.of(60 of PLATINUM_BAR, 150 of ALUMINUM_BAR, 40 of TITANIUM_BAR)),
    TELESCOPE(Price(2_500_000_000), Price(5_000_000_000), 16800.sec(), Resources.of(20 of LENSE, 1 of ADVANCED_COMPUTER)),
    SATELLITE_DISH(Price(3_400_000_000), Price(17_500_000_000), 18000.sec(), Resources.of(150 of STEEL_BAR, 20 of PALADIUM_BAR)),
    MOTOR(Price(7_000_000_000), Price(60_000_000_000), 19200.sec(), Resources.of(400 of BRONZE_BAR, 200 of HAMMER)),
    ACCUMULATOR(Price(10_000_000_000), Price(100_000_000_000), 20400.sec(), Resources.of(20 of OSMIUM_BAR, 2 of ADVANCED_BATTERY)),
    NUCLEAR_CAPSULE(Price(23_000_000_000), Price(250_000_000_000), 21000.sec(), Resources.of(5 of RHODIUM_BAR, 1 of PLASMA_TORCH)),
    WIND_TURBINE(Price(140_000_000_000), Price(500_000_000_000), 21600.sec(), Resources.of(150 of ALUMINUM_BAR, 1 of MOTOR)),
